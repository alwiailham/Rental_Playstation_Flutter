...
class PS1Page extends StatefulWidget {
  final int id;
  final String type;
  ...
  @override
  _PS1PageState createState() => _PS1PageState();
}

class _PS1PageState extends State<PS1Page> {
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('lib/assets/3.jpg'), // Ganti dengan URL gambar PlayStation
                fit: BoxFit.cover,
              ),
            ),
          ),
